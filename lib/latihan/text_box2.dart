...
class TextBoxPage2 extends StatefulWidget {
  const TextBoxPage2({super.key});

  @override
  State<TextBoxPage2> createState() => _TextBoxPageState();
}

class _TextBoxPageState extends State<TextBoxPage2> {
